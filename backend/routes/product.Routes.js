...
const { addProducts, getProducts, getProductById, deleteProducts, updateProducts } = require('../controllers/productController');
...
router.post('/',upload.single('image'), checkAuthAdmin, addProducts)
